...
(function () {
    ...
    tagsInput.run(["$templateCache", function ($templateCache) {
        $templateCache.put('ngTagsInput/tags-input.html',
            "<div class=\"host\" tabindex=\"-1\" ng-click=\"eventHandlers.host.click()\" ti-transclude-append><div class=\"tags\" " +
            "ng-class=\"{focused: hasFocus}\"><ul class=\"tag-list\"><li class=\"tag-item\" " +
            ...
            "</ti-tag-item></li></ul>" +
            "<input class=\"input\" autocomplete=\"off\" ng-model=\"newTag.text\" ng-model-options=\"{getterSetter: true}\" " +
            "ng-keydown=\"eventHandlers.input.keydown($event)\" ng-focus=\"eventHandlers.input.focus($event)\" " +
            "ng-blur=\"eventHandlers.input.blur($event)\" ng-paste=\"eventHandlers.input.paste($event)\" " +
            "ng-trim=\"false\" ng-class=\"{'invalid-tag': newTag.invalid}\" ng-disabled=\"disabled\"" +
        ...
        $templateCache.put('ngTagsInput/tag-item.html',
            "<span ng-bind=\"$getDisplayText()\"></span> <a class=\"remove-button\" ng-click=\"$removeTag()\"> <i class=\"main-icon-2-cancel\"></i></a>"
        );

        $templateCache.put('ngTagsInput/auto-complete.html',
            "<div class=\"autocomplete\" ng-if=\"suggestionList.visible\"><ul class=\"suggestion-list\">" +
