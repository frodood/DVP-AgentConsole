...
agentApp.directive("engagementTab", function ($filter, $rootScope, engagementService, ivrService, userService, ticketService, tagService, $http) {
    return {
        restrict: "EA",
        scope: {
            company: "@",
        ...
        link: function (scope, element, attributes) {
            ...
            //get languages list
            getJSONData($http, "languages", function (data) {
