...
agentApp.factory("ticketService", function ($http, baseUrls,authService) {
    ...
    var getNewTickets = function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"Tickets/5/"+page+"?status=new",
            headers: {
    ...
    var getOpenTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"Tickets/5/"+page+"?status=open&status=progressings",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var  getClosedTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"Tickets/5/"+page+"?status=parked&status=solved&status=closed",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var getMyNewTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"MyTickets/5/"+page+"?status=new",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var getMyOpenTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"MyTickets/5/"+page+"?status=open&status=progressings",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var getMyClosedTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"MyTickets/5/"+page+"?status=parked&status=solved&status=closed",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var getMyGroupTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"MyGroupTickets/5/"+page+"?status=new",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var getMyGroupOpenTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"MyGroupTickets/5/"+page+"?status=open&status=progressings",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
    ...
    var getMyGroupClosedTickets= function (page) {
        ...
        return $http({
            method: 'GET',
            url: baseUrls.ticketUrl+"MyGroupTickets/5/"+page+"?status=parked&status=solved&status=closed",
            headers: {
                'authorization':authToken
            }
        }).then(function(response)
